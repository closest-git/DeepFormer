...
DL_PATH = "/tmp/cifar10/" # Use your own path
...
def VIM_test():
    ...
    #https://github.com/tahmid0007/VisionTransformer/blob/main/Google_ViT.py    image_size=32, patch_size=4, num_classes=10, channels=3,dim=64, depth=6, heads=8, mlp_dim=128
    model = ImageTransformer(image_size=32, patch_size=4, num_classes=10, channels=3,dim=64, depth=6, heads=8, mlp_dim=128)          #
    print(model)
    if isCuda:
        model.cuda()
